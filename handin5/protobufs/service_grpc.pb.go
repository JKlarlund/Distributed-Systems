...
const (
	...
	AuctionService_Heartbeat_FullMethodName     = "/auctionService/Heartbeat"
)
...
func (c *auctionServiceClient) Heartbeat(ctx context.Context, in *HeartbeatMessage, opts ...grpc.CallOption) (*HeartbeatMessage, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAuctionServiceServer) Heartbeat(context.Context, *HeartbeatMessage) (*HeartbeatMessage, error) {
...
func _AuctionService_Heartbeat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuctionServiceServer).Heartbeat(ctx, req.(*HeartbeatMessage))
	}
	return interceptor(ctx, in, info, handler)
}
